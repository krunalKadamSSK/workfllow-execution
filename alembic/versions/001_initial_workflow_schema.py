...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["node_definition_id"], ["node_definitions.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["workflow_definition_version_id"], ["workflow_definition_versions.id"]
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_index(
        "ix_workflow_events_instance_created",
        "workflow_events",
    ...
    op.create_table(
        ...
        sa.Column("completed_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["workflow_node_instance_id"], ["workflow_node_instances.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
