...
class WorkflowInstance(Base):
    ...
    __table_args__ = (
        Index("ix_workflow_instances_created_at", "created_at"),
        Index("ix_workflow_instances_status_created", "status", "created_at"),
        Index("ix_workflow_instances_definition_id", "workflow_definition_id"),
        Index(
            "ix_workflow_instances_definition_version_id",
            "workflow_definition_version_id",
        ),
        Index("ix_workflow_instances_rfq_id_status", "rfq_id", "status"),
    )
...
class WorkflowNodeExecution(Base):
    ...
    __table_args__ = (
        UniqueConstraint("workflow_node_instance_id", "execution_number"),
        Index(
            "ix_workflow_node_executions_instance_started",
