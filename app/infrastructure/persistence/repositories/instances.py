...
from app.infrastructure.persistence.repositories.instance_list_queries import (
    InstanceListQueryMixin,
)
from app.infrastructure.persistence.repositories.node_execution_queries import (
    NodeExecutionQueryMixin,
)


class InstanceRepository(NodeExecutionQueryMixin, InstanceListQueryMixin):
