...
class EventStore:
    ...
    def list_workflow_events(self, workflow_instance_id: str, *, after_sequence: int | None = None):
        return self._events.list_events(workflow_instance_id, after_sequence=after_sequence)
