...
from app.domain.definitions.table_fields import TABLE_ROWS_INPUT_KEY
from app.domain.enums import ExecutionStatus
from app.domain.exceptions import NotFoundError, ValidationError
from app.domain.seed.field_classifier import (
    FieldSeedClassifier,
    StaticFieldClassifier,
    filter_static_outputs,
)
from app.infrastructure.db.models import WorkflowInstance, WorkflowNodeExecution
...
class SeedDefaultsMementoBuilder:
    ...
    def _static_defaults_for_definition(
        ...
        *,
        ...
        base_kind = str(definition_json.get("baseKind") or "")
        if base_kind == "table":
            return self._static_table_defaults(definition_json, outputs)
    ...
    def _static_table_defaults(
        ...
        # Row data is user-entered; keep prior rows as static defaults.
